...
# Specify the map file name
map_file_name = "cape_python.png"

# Concatenate the directory path and the map file name
MAP_FILE = os.path.join(current_directory, map_file_name)
